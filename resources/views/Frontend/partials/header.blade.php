              ...
              <ul class="dropdown-menu">
                <li>
                  <div class="cart-item product-summary">
                    <div class="row">
                      <div class="col-xs-4">
                        <div class="image"> <a href="detail.html"><img src="{{asset('public/Frontend')}}/assets/images/cart.jpg" alt=""></a> </div>
                      </div>
                      <div class="col-xs-7">
                      ...
                      <li>
                        <div class="yamm-content">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="{{asset('public/Frontend')}}/assets/images/banners/banner-side.png"></a> </div>
                          </div>
                          <!-- /.row -->
                        </div>
                        <!-- /.yamm-content --> </li>
