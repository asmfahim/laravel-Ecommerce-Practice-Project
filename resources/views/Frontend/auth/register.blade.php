    ...
    <div class="container">
        <div class="sign-in-page">
            ...
            <ul class="row nav nav-tabs text-center">
                <li class="nav-item col-md-6 "><a class="nav-link" data-toggle="pill" href="#login">Login Form</a></li>
                <li class="nav-item col-md-6 active"><a class="nav-link" data-toggle="pill" href="#menu1">Register Form</a></li>
              </ul>

              <div class="tab-content">
                <div id="login" class="tab-pane fade  pb-md-2">
                ...
                <div id="menu1" class="tab-pane fade in active pb-md-2">
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        <form class="register-form outer-top-xs" role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <label class="info-title" for="exampleInputNameuser">User Name <span>*</span></label>
                                <input type="text" class="form-control unicase-form-control text-input @error('username') is-invalid @enderror" id="exampleInputNameuser" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                            </div>
                            <div class="form-group">
